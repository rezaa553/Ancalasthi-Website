      ...
      <div class="carousel-item active">
        ...
        <div class="container">
          <div class="carousel-caption text-left">
            ...
            <p><a class="btn btn-lg btn-primary" href="#" role="button">Lebih Lanjut</a></p>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-4">
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <h6 class="card-text font-italic">Co-Founder</h6>
      ...
      <div class="col-sm-4">
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <h6 class="card-text font-italic">Founder</h6>
